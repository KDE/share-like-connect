...
#ifndef PROVIDERINFOSHARED_H
#define PROVIDERINFOSHARED_H

#include <libkipi/imageinfoshared.h>
#include "kipiinterface.h"

class ProviderInfoShared : public KIPI::ImageInfoShared
{
public:
    ProviderInfoShared(KIPIInterface* interface, const KUrl& url);
